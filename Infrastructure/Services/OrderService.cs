...
public class OrderService : IOrderService
{
        ...
        OrderedAddress address)
    {
        ...
        var items = products.Select(p =>
            {
                var orderdProduct = new OrderedProduct(
                    (int)p.Id, p.Name, p.Description, p.PictureUrl);
        ...
        var order = await this.GetOrderByPaymentIntentId(
    ...
    public async Task<IReadOnlyList<DeliveryMethod>>
    ...
    public async Task<Order>
        GetOrderByIdAsync(int id, string buyerEmail)
    {
    ...
    public async Task<Order>
        GetOrderByPaymentIntentId(string paymentIntentId)
    {
    ...
    public async Task<IReadOnlyList<Order>>
        GetUserOrdersAsync(string buyerEmail)
    {
